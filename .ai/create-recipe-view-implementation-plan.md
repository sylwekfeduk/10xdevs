...
* **User loads `/recipes/new`:**
    * *Authenticated:* The page renders the empty form.
    * *Unauthenticated:* The user is redirected to the login page.
...
* **User clicks "Submit" (with valid data):**
    ...
    * *On Success (201):* The user is redirected to `/recipes/[new_id]`.
    * *On Error (400/500):* The loading state stops, and an error message is displayed (either next to the field or in the global `Alert`).
