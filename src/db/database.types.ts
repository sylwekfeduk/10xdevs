    ...
    Tables: {
      ...
      recipes: {
        Row: {
          ...
          copied_from_master_id: string | null
          created_at: string
          id: string
          ingredients: string
          instructions: string
        ...
        Relationships: [
          {
            foreignKeyName: "recipes_copied_from_master_id_fkey"
            columns: ["copied_from_master_id"]
            isOneToOne: false
...
A new version of Supabase CLI is available: v2.58.5 (currently installed v2.53.6)
